## Table of Contents
* [Modes and Basic movement](#modes-and-basic-movement)
...
* [Markers](#markers)
* [Invoking the command line directly from vim](#invoking-the-command-line-directly-from-vim)
* [Buffers](#buffers)
* [Windows and tabs](#windows-and-tabs)
* [Indents and folds](#indents-and-folds)
* [Vimrc file](#vimrc-file)
* [Others](#others)

link: https://raw.githubusercontent.com/ChillarAnand/Vim-Cheat-Sheet/master/README.md
...
`d/chalam` - delete all the text from the postion of cursor to text it works the same with change and yank.
